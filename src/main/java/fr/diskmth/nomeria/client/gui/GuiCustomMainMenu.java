package fr.diskmth.nomeria.client.gui;
...
public class GuiCustomMainMenu extends GuiScreen
{
    ...
    private static final ResourceLocation SPLASH_TEXTS = new ResourceLocation(References.MODID + ":textures/gui/main_menu/splash.txt");
    private static final ResourceLocation LOGO = new ResourceLocation(References.MODID + ":textures/logo/logo_512x.png");
    private static final ResourceLocation[] TITLE_PANORAMA_PATHS = new ResourceLocation[] {new ResourceLocation(References.MODID + ":textures/gui/main_menu/background/panorama_0.png"), new ResourceLocation(References.MODID + ":textures/gui/main_menu/background/panorama_1.png"), new ResourceLocation(References.MODID + ":textures/gui/main_menu/background/panorama_2.png"), new ResourceLocation(References.MODID + ":textures/gui/main_menu/background/panorama_3.png"), new ResourceLocation(References.MODID + ":textures/gui/main_menu/background/panorama_4.png"), new ResourceLocation(References.MODID + ":textures/gui/main_menu/background/panorama_5.png")};
    ...
    public void initGui()
    {
        ...
        this.widthCopyright = this.fontRenderer.getStringWidth("Nomeria n'est en aucun cas affilie a Mojang AB ");
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id == 2)
        {
            FMLClientHandler.instance().connectToServer(this, new ServerData("nomeria", "play.nomeria-mc.fr:25565", false));
        }
    ...
    public void drawLogo()
    {
        ...
        bb.pos((double)this.width / 2 - (this.width / 9.6), (double)15, (double)this.zLevel).tex((double)0, (double)0).endVertex();
        bb.pos((double)this.width / 2 - (this.width / 9.6), (double)this.height / 2 - (this.height / 6.25), (double)this.zLevel).tex((double)0, (double)1).endVertex();
        bb.pos((double)this.width / 2 + (this.width / 9.6), (double)this.height / 2 - (this.height / 6.25), (double)this.zLevel).tex((double)1, (double)1).endVertex();
        bb.pos((double)this.width / 2 + (this.width / 9.6), (double)15, (double)this.zLevel).tex((double)1, (double)0).endVertex();
        tess.draw();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        this.drawString(this.fontRenderer, "Nomeria n'est en aucun cas affilie a Mojang AB", this.widthCopyrightRest, this.height - 10, -1);
