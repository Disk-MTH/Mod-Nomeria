package fr.diskmth.nomeria.objects.entity;
...
{
    private static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(EntityPillerTNTPrimed.class, DataSerializers.VARINT);
    @Nullable
